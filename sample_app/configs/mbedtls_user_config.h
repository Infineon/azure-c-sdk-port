...
/**
 * \def MBEDTLS_SSL_CIPHERSUITES
 * 
 * Macro to add supported cipher suites.
 * 
 * FreeRTOS PSA PKCS11 library(https://github.com/Linaro/freertos-pkcs11-psa) supports only SHA-256 Algorithm.
 * To enforce server to use SHA256 during TLS handshake, this macro needs to be updated with cipher suites which uses SHA256 Algorithm.
 * Refer https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-tls-support#cipher-suites for Azure Hub supported cipher suites.
 * Refer https://docs.microsoft.com/en-us/azure/iot-dps/tls-support#recommended-ciphers for Azure DPS recommended cipher suites.
 *
 * \note This macro needs to be updated according to server supported cipher suites and FreeRTOS PSA PKCS11 library supported cipher suites.
 * For Azure DPS and Hub applications, below cipher suites are added.
 *
 */
