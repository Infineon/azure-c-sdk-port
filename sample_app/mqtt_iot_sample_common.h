...
/**
 * @file mqtt_iot_sample_common.h
 * Header file for Azure sample applications utility functions on Cypress platforms
 */
 ...
 * @param[out] endpoint Buffer with sufficient capacity to hold the built endpoint. If
